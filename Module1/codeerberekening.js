...
totaleverdiepingen = (gewenste_aantal_autos - 80)/120
...
if (totaleverdiepingen > 0)
    totaleverdiepingen += 1 
if (gewenste_aantal_autos < 80)
    totaleverdiepingen = 1
console.log("Om het gewenste aantal autos kwijt te kunnen heb ik ", totaleverdiepingen," verdiepingen nodig.")
